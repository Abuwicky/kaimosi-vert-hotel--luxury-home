...
import { Wifi, Tv, Droplets, Coffee, Wind, Shield, Star, ArrowRight } from 'lucide-react';
...
const rooms = [
  ...
  },
  {
    ...
    amenityLabels: ['Free WiFi', 'Smart TV', 'Hot Shower', 'Coffee Maker', 'AC'],
    badge: 'Most Popular',
  },
  {
    id: 3,
    ...
    amenityLabels: ['Free WiFi', 'Smart TV', 'Hot Shower', 'Coffee Maker', 'AC', 'Safe'],
    badge: null,
  },
  {
    id: 4,
    ...
    >
      ...
      <div className="relative overflow-hidden h-56 sm:h-64">
        ...
        <div className="absolute bottom-4 left-4">
          <p className="text-gold text-xs uppercase tracking-widest">{room.category}</p>
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-3">
          <h3 className="font-serif text-2xl font-light text-charcoal">{room.name}</h3>
          <p className="text-forest font-semibold text-sm whitespace-nowrap ml-2">{room.price}</p>
        </div>

        <p className="text-charcoal/60 text-sm leading-relaxed mb-5">{room.desc}</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={titleRef} className="reveal text-center mb-16">
          ...
          <p className="mt-6 text-charcoal/60 max-w-xl mx-auto leading-relaxed">
            Each room is thoughtfully designed to blend modern luxury with the natural beauty of Kaimosi Forest — your perfect sanctuary awaits.
          </p>
          ...
          <div className="inline-flex items-center gap-2 mt-6 bg-red-50 border border-red-200 px-5 py-2.5 text-sm text-red-700">
            ...
            Limited rooms available this season — book early to secure your preferred room!
          </div>
        </div>
