        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-white font-serif text-lg leading-tight tracking-wide">Kaimosi Vert</p>
                <p className="text-gold/70 text-[9px] uppercase tracking-[0.25em]">Hotel & Retreat</p>
              </div>
            </div>
          </div>
