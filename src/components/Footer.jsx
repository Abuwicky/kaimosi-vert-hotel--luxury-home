      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-gold/60 text-[9px] uppercase tracking-[0.25em]">
                  Hotel & Retreat
                </p>
              </div>
            </div>
            <p className="text-white/50 text-sm leading-relaxed mb-6">
              A luxury nature retreat nestled near Kaimosi Forest in
              Shamakhokho, Vihiga. Where tranquility meets hospitality.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3 items-start">
                ...
                <p className="text-white/50 text-sm">
                  Shamakhokho, Vihiga County, Western Kenya
                </p>
              </div>
            ...
            <button
              onClick={onBookClick}
              className="mt-6 btn-primary text-xs py-3 px-6"
            >
              Book Now
            </button>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-row items-center justify-between gap-3 flex-wrap">
          <p className="text-white/30 text-xs">
            © 2026 Kaimosi Vert Hotel. All rights reserved. | Shamakhokho,
            Vihiga, Kenya
          </p>
