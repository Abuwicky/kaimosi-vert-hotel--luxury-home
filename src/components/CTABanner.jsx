...
export default function CTABanner({ onBookClick }) {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url(https://images.unsplash.com/photo-1615880484746-a134be9a6ecf?w=1920&q=80)",
    ...
    >
      ...
      <div
        ref={ref}
        className="reveal relative z-10 text-center max-w-3xl mx-auto px-4"
      >
        ...
        <p className="text-white/70 text-lg mb-3 max-w-lg mx-auto">
          Limited rooms available. Secure your perfect forest retreat before
          it's too late.
        </p>
        ...
        <p className="text-white/40 text-xs mt-6">
          📍 Shamakhokho, Vihiga · 📞 +254 794408594
        </p>
      </div>
    </section>
  );
